...
> **2026-06-22 patch-lane reservation**：为补丁发布留出 `v0.1.21-v0.1.25`；所有 `v0.1.21` 及之后的 planned 0.1.x 版本整体后移 5 个版本，F103 落到 `v0.1.26`，后续 capability catch-up / beta hardening 落到 `v0.1.36-v0.1.39`。
...
| **v0.1.21-v0.1.25** | Patch reserve                         | none                                     | Reserved for patch-only releases; no planned feature work is assigned here.                                                                                                                                                      |
