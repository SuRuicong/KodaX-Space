...
> Last Updated: 2026-06-22 (v0.1.22 released: package/lockfile/runtime contract/docs are aligned to `0.1.22`; release scope is trusted internal custom providers, config-provider compatibility, Space-owned per-session follow-up queue, ask_user modal bridge coverage, and release hygiene. v0.1.23 and v0.1.25 remain patch lanes; v0.1.24 remains F105 customer timebox entitlement MVP).
...
> **2026-06-22 patch-lane reservation**: `v0.1.21` shipped as the first patch release; `v0.1.22` is now consumed by the provider/queue patch; `v0.1.23` remains the next emergency patch reserve, `v0.1.24` remains customer timebox entitlement MVP, and `v0.1.25` remains a post-entitlement patch reserve before F103 starts at `v0.1.26`.
...
| **v0.1.22** | Provider / queue patch                          | none                                     | Trusted internal custom-provider paths, config-provider compatibility, Space-owned per-session follow-up queue, ask_user bridge coverage, and release metadata alignment.                                                        |
| **v0.1.23** | Patch reserve                                   | none                                     | Reserved for patch-only releases; no planned feature work is assigned here.                                                                                                                                                      |
...
| **v0.1.25** | Post-entitlement patch reserve                 | none                                     | Reserved for customer-entitlement regression fixes and patch-only release work before F103 starts.                                                                                                                               |
