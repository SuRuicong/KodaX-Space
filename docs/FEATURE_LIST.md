...
> Last Updated: 2026-06-23 (v0.1.25 / F107 KodaX 0.7.54 SDK Catch-up is completed: dependency, GLM refresh, learning inbox, ledgers, recovery preview, extension discovery/runtime opt-in, manual topic, and completed-turn learning lifecycle are aligned before F103 starts at v0.1.26).
...
| 106     | Runtime Defaults and Mode Persistence (Space-owned Plan / Accept edits / Auto defaults, per-session mode sidecars, KodaX config fallback)                                      | Enhancement  | High     | v0.1.23          | Planned    | [v0.1.23.md#feature_106-runtime-defaults-and-mode-persistence](features/v0.1.23.md#feature_106-runtime-defaults-and-mode-persistence)                                     |
...
| **v0.1.25** | KodaX 0.7.54 SDK catch-up                      | F107                                     | Dependency/GLM refresh, learning inbox, learning ledgers, recovery seed preview, extension discovery/runtime opt-in, manual topic, and completed-turn learning lifecycle keep Space matched to SDK 0.7.54 before F103 starts.       |
