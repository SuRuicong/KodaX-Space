...
> **2026-06-19 GLM gap review follow-up**：吸收合理项但不照单全收。MCP gap 结论作废（F039 已完成）；`CHANGELOG:51` provider 安全风险在当前工作树已有 `apiKeyEnv`/`baseUrl` guard 与测试，作为 F094 release verification；OS 级执行沙箱是战略方向但不打断 v0.1.31-v0.1.33，先在 F094 输出 feasibility，后续与 F099/self-hosted runner 或独立 sandbox feature 合流；PR/GitHub 闭环并入 F096 connector + F095 Partner workbench；企业 SSO/SAML/SCIM 降级为路线选择后再开，F098 只做 local-first policy/audit。
> **2026-06-21 v0.1.21 lane reset**：v0.1.21 改为承载 F103「Pinned Runtime Summary and Live Detail Host」。原 v0.1.21-v0.1.24 的 planned 0.1.x feature 不改 ID、不改状态，整体后移到 v0.1.31-v0.1.34；v0.1.22-v0.1.30 暂不承载已承诺 feature，留给 F103 polish / 回归 / SDK 紧急跟进。
...
| 085     | Workflow Durable Replay Resume UI（resumable/replaying/orphaned 状态、恢复/丢弃动作、replay 解释）                                                                               | Enhancement  | High     | v0.1.31          | Planned    | [v0.1.20.md#feature_085-workflow-durable-replay-resume-ui](features/v0.1.20.md#feature_085-workflow-durable-replay-resume-ui)                                             |
| 086     | Workflow Draft Review and Approval UI（generate-without-run / review-before-start 桌面审阅）                                                                                     | New          | High     | v0.1.31          | Planned    | [v0.1.20.md#feature_086-workflow-draft-review-and-approval-ui](features/v0.1.20.md#feature_086-workflow-draft-review-and-approval-ui)                                     |
| 087     | Workflow Pipeline Timeline and Replay-Aware Rendering（pipeline 阶段时间线、fan-out/fan-in、replay 标记）                                                                        | Enhancement  | Medium   | v0.1.31          | Planned    | [v0.1.20.md#feature_087-workflow-pipeline-timeline-and-replay-aware-rendering](features/v0.1.20.md#feature_087-workflow-pipeline-timeline-and-replay-aware-rendering)     |
| 088     | Memory Governance Surface（proposed/approved/conflict/stale memory，区分 Coder memory 与 Partner KB）                                                                            | New          | High     | v0.1.32          | Planned    | [v0.1.20.md#feature_088-memory-governance-surface](features/v0.1.20.md#feature_088-memory-governance-surface)                                                             |
| 089     | Todo Timeline and Session Report（todo_update → durable plan/timeline/session-end report）                                                                                       | Enhancement  | Medium   | v0.1.32          | Planned    | [v0.1.20.md#feature_089-todo-timeline-and-session-report](features/v0.1.20.md#feature_089-todo-timeline-and-session-report)                                               |
| 090     | MCP / Extension Resume State Inspector（resumed session 的 MCP/extension state、missing/stale/reconnect UX）                                                                     | Enhancement  | Medium   | v0.1.32          | Planned    | [v0.1.20.md#feature_090-mcp--extension-resume-state-inspector](features/v0.1.20.md#feature_090-mcp--extension-resume-state-inspector)                                     |
...
| 103     | Pinned Runtime Summary and Live Detail Host（右侧置顶摘要：idle 环境信息 / running live 摘要 / 展开完整信息面板）                                                                | Enhancement  | High     | v0.1.21          | Planned    | [v0.1.21.md#feature_103-pinned-runtime-summary-and-live-detail-host](features/v0.1.21.md#feature_103-pinned-runtime-summary-and-live-detail-host)                         |
...
> Current planning overlay (2026-06-19): `v0.1.19` 已 release，作为当前发布基线；本段是唯一版本矩阵。下方历史表保留早期 M0/M1/opencode 规划语境；新规划以本段为准。
...
| **v0.1.21** | Pinned runtime summary                         | F103                                     | Right-side pinned summary shows idle environment or live runtime status, with a clear path into the full information panel.                                                                                                      |
| **v0.1.31** | Workflow v2 desktop host                       | F085, F086, F087                         | Space supports workflow replay resume, draft review, and pipeline timeline.                                                                                                                                                      |
| **v0.1.32** | Governance surfaces                            | F088, F089, F090                         | Memory, todos, and MCP/extension resume state are visible and reviewable.                                                                                                                                                        |
...
| **v0.2.3**  | Platform, runner, sandbox, data surfaces       | F042, F055, F067, F099, F100, F101, F102 | Native helper parking lot, app protocol hardening, LiveCanvas re-integration gate, self-hosted runner/worktree sandbox, notebook/data work, distribution, and slot registry are specified.                                       |
