...
> Last Updated: 2026-06-19 (GLM gap review follow-up：确认 `v0.1.20` 之前无新旧债；F081-F084 当前工作树已 Done；provider custom config 安全项已在工作树补 guard，纳入 F094 release verification；OS 执行沙箱先做 F094 feasibility，实施落 F099/后续；PR/GitHub 闭环归入 F096/F095；企业 SSO/SAML/SCIM 不进当前 0.2.x，F098 保持 local-first policy/audit)。
...
| 069     | Electron 主进程统一日志（Logger）工程（分级 + 结构化 + 落盘轮转 + 敏感信息脱敏 + 替换 33 文件 console.* + no-console lint；合流 OC-04/05/10）                                     | Internal     | Low      | v0.1.24         | Planned    | [unplanned.md#F069](features/unplanned.md#f069--electron-主进程统一日志logger工程)                                                          |
...
| 076     | UI Language Switch and i18n Foundation（中/英显示语言：系统跟随 + 显式覆盖；全局菜单、设置、侧栏、面板、弹窗、toast 走 typed locale）                                            | Enhancement  | High     | v0.1.24         | Planned    | [v0.1.18.md#feature_076-ui-language-switch-and-i18n-foundation](features/v0.1.18.md#feature_076-ui-language-switch-and-i18n-foundation)     |
| 077     | dev-only pseudo-locale / 文案扩展 QA（拉长字符串、发现溢出、辅助 i18n 回归）                                                                                                      | Internal     | Low      | v0.1.24         | Planned    | [v0.1.18.md#后续-feature](features/v0.1.18.md#后续-feature)                                                                                 |
| 078     | i18n scanner 从 advisory 升级为 CI required（阻止新增高频 UI 硬编码文案）                                                                                                         | Internal     | Medium   | v0.1.24         | Planned    | [v0.1.18.md#后续-feature](features/v0.1.18.md#后续-feature)                                                                                 |
...
| 085     | Workflow Durable Replay Resume UI（resumable/replaying/orphaned 状态、恢复/丢弃动作、replay 解释）                                                                                | Enhancement  | High     | v0.1.21         | Planned    | [v0.1.20.md#feature_085-workflow-durable-replay-resume-ui](features/v0.1.20.md#feature_085-workflow-durable-replay-resume-ui)              |
| 086     | Workflow Draft Review and Approval UI（generate-without-run / review-before-start 桌面审阅）                                                                                      | New          | High     | v0.1.21         | Planned    | [v0.1.20.md#feature_086-workflow-draft-review-and-approval-ui](features/v0.1.20.md#feature_086-workflow-draft-review-and-approval-ui)      |
| 087     | Workflow Pipeline Timeline and Replay-Aware Rendering（pipeline 阶段时间线、fan-out/fan-in、replay 标记）                                                                          | Enhancement  | Medium   | v0.1.21         | Planned    | [v0.1.20.md#feature_087-workflow-pipeline-timeline-and-replay-aware-rendering](features/v0.1.20.md#feature_087-workflow-pipeline-timeline-and-replay-aware-rendering) |
| 088     | Memory Governance Surface（proposed/approved/conflict/stale memory，区分 Coder memory 与 Partner KB）                                                                             | New          | High     | v0.1.22         | Planned    | [v0.1.20.md#feature_088-memory-governance-surface](features/v0.1.20.md#feature_088-memory-governance-surface)                              |
| 089     | Todo Timeline and Session Report（todo_update → durable plan/timeline/session-end report）                                                                                        | Enhancement  | Medium   | v0.1.22         | Planned    | [v0.1.20.md#feature_089-todo-timeline-and-session-report](features/v0.1.20.md#feature_089-todo-timeline-and-session-report)                |
| 090     | MCP / Extension Resume State Inspector（resumed session 的 MCP/extension state、missing/stale/reconnect UX）                                                                      | Enhancement  | Medium   | v0.1.22         | Planned    | [v0.1.20.md#feature_090-mcp--extension-resume-state-inspector](features/v0.1.20.md#feature_090-mcp--extension-resume-state-inspector)      |
| 091     | Effort-First Provider Routing UI（任务感知 effort/model 控制、能力徽标、why-this-route）                                                                                          | Enhancement  | High     | v0.1.23         | Planned    | [v0.1.20.md#feature_091-effort-first-provider-routing-ui](features/v0.1.20.md#feature_091-effort-first-provider-routing-ui)                |
| 092     | Advisor Consult Review Surface（计划/diff/workflow/artifact 的跨模型可验证审阅）                                                                                                  | New          | High     | v0.1.23         | Planned    | [v0.1.20.md#feature_092-advisor-consult-review-surface](features/v0.1.20.md#feature_092-advisor-consult-review-surface)                    |
| 093     | Skill Self-Improvement Review Surface（skill proposal/diff/test/activate/rollback）                                                                                               | New          | High     | v0.1.23         | Planned    | [v0.1.20.md#feature_093-skill-self-improvement-review-surface](features/v0.1.20.md#feature_093-skill-self-improvement-review-surface)      |
| 094     | Beta Quality, Release Cohesion, and Sandbox Feasibility（版本/docs/diagnostics/provider guard/smoke checklist + 执行沙箱 feasibility）                                             | Internal     | Medium   | v0.1.24         | Planned    | [v0.1.20.md#feature_094-beta-quality-and-release-cohesion](features/v0.1.20.md#feature_094-beta-quality-and-release-cohesion)              |
...
| **v0.1.18** | Emergency released baseline   | none                                   | Emergency release already shipped; unimplemented i18n foundation moves to v0.1.24. |
| **v0.1.19** | Released baseline             | none                                   | Package baseline is released; forward planning starts at v0.1.20. |
| **v0.1.20** | Rebaseline + continuity       | F081, F082, F083, F084                 | KodaX capability ledger exists; Space-owned diagnostics/continuity/handoff receiver paths work; SDK-gated gaps are explicit. |
| **v0.1.21** | Workflow v2 desktop host      | F085, F086, F087                       | Space supports workflow replay resume, draft review, and pipeline timeline. |
| **v0.1.22** | Governance surfaces           | F088, F089, F090                       | Memory, todos, and MCP/extension resume state are visible and reviewable. |
| **v0.1.23** | Intelligent control surfaces  | F091, F092, F093                       | Provider effort, advisor consult, and skill self-improvement are desktop workflows. |
| **v0.1.24** | Beta hardening + sandbox feasibility | F069, F076, F077, F078, F094           | Logging, i18n foundation/QA, release health, provider guard verification, diagnostics, and sandbox feasibility are coherent for beta users. |
