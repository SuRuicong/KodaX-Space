...
> Last Updated: 2026-06-24 (F105 moved to InProgress: `v0.1.24` embeds the issuer `kai-prod-2026-q3` public verification key and keeps Community/no-license plus Enterprise licensed/evaluation semantics).
...
> 2026-06-22 (Display Language MVP 前移：从 F076 全量 i18n foundation 中拆出 F104，纳入 `v0.1.20`，先覆盖菜单、Settings、侧栏、右栏标题和常用弹窗；F076/F077/F078 保留在 `v0.1.35` 负责全量 typed locale、pseudo-locale 和 CI scanner)。
...
> **2026-06-18 full feature audit / emergency release cleanup**：校验全部 feature 后，发现 F049/F050/F051/F052/F053/F055/F070/F076 仍无实现证据却挂在已发布版本；F067/F069 仍为 TBD。统一重排：F015/F017/F018 的未完成部分由 v0.1.20 的 F082/F084/F083 承接；F076/F069 进入 v0.1.35 beta hardening；F049/F070/F071/F072/F074/F095 进入 v0.2.0；F050/F051/F052/F073/F080/F096/F097 进入 v0.2.1；F053/F075/F079/F098 进入 v0.2.4；F042/F055/F067/F099-F102 进入 v0.2.5。历史 v0.1.17/v0.1.18 改为 emergency released baseline，不再承载 Planned feature。
...
> **2026-06-22 Display Language MVP split**：用户确认中/英显示语言需要提前进入 `v0.1.20`。新增 F104「Display Language MVP」作为 F076 的前置交付：只做可用语言偏好、菜单栏快捷切换、Settings 入口和高频 chrome/弹窗覆盖；F076 仍留在 `v0.1.35` 做全量 i18n foundation、typed locale 扩面、pseudo-locale/CI scanner 前置条件。
...
> **2026-06-24 v0.1.26+ patch cadence replan**: starting at `v0.1.26`, two feature-bearing versions are followed by two reserved patch version numbers. `v0.1.28-v0.1.29`, `v0.1.32-v0.1.33`, and `v0.1.36-v0.1.37` are patch reserves; later v0.2.x work keeps `v0.2.0-v0.2.1` as the first feature pair, reserves `v0.2.2-v0.2.3`, and moves the later two planned feature lanes to `v0.2.4-v0.2.5`.
...
> **2026-06-25 roadmap +1 shift (accidental v0.1.25 release)**: `v0.1.25` shipped early as the KodaX 0.7.56 SDK catch-up instead of the planned feature batch, so every planned 0.1.x lane from the former `v0.1.25` onward is renumbered +1 to free the slot: former `v0.1.25` (F107/F108) → `v0.1.26`, former `v0.1.26` (F103 Pinned Runtime Summary) → `v0.1.27`, with the two-feature/two-patch cadence preserved through the shift (former `v0.1.34` beta-hardening lane → `v0.1.35`). The `v0.2.x` milestones are unchanged. Released tags `v0.1.22`–`v0.1.25` and their CHANGELOG sections are final and untouched; only planning docs were renumbered (the dated notes above were shifted in lockstep for internal consistency). `v0.1.25` is intentionally absent from the planning lane because it is already a published release.
## Index
...
| 014     | NAPI native-tokenizer — 与 F025/F026b 合并入 [F042](features/v0.1.4.md#feature_042-napi-native-helpers合并版)                                                                    | Refactor     | Low      | v0.2.5 via F042  | Merged     | [v0.1.1.md#014](features/v0.1.1.md#feature_014-napi-native-tokenizer)                                                                                                     |
...
| 042     | NAPI native-helpers（合并 F014 tokenizer + F025 diff + F026b fuzzy）                                                                                                             | Refactor     | Low      | v0.2.5           | Deferred   | [v0.1.4.md#042](features/v0.1.4.md#feature_042-napi-native-helpers合并版)                                                                                                 |
...
| 053     | Partner 自定义画像 + H1-Partner 完整 harness（依赖 SDK R1/R2）                                                                                                                   | New          | High     | v0.2.4           | Blocked    | [v0.1.14.md#feature_053](features/v0.1.14.md#feature_053-partner-自定义画像--h1-partner-完整-harness)                                                                     |
...
| 055     | 打包 renderer 迁 `app://` 自定义标准协议（artifact 嵌入安全地基；file:// → app://space 真实可锁 origin）                                                                         | Refactor     | High     | v0.2.5           | Planned    | [v0.1.12.md#feature_055](features/v0.1.12.md#feature_055-打包-renderer-迁-app-自定义标准协议)                                                                             |
...
| 067     | LiveCanvas Artifact Sandbox 重新集成（交互 `react` tier；2026-06-17 整支移除以解 LC 半成品卡死 dev/build/pack，待 LC 包稳定后重接，硬约束=无 LC 也能构建）                       | New          | Medium   | v0.2.5           | Blocked    | [设计](features/unplanned.md)                                                                                                                                             |
...
| 069     | Electron 主进程统一日志（Logger）工程（分级 + 结构化 + 落盘轮转 + 敏感信息脱敏 + 替换 33 文件 console.\* + no-console lint；合流 OC-04/05/10）                                   | Internal     | Low      | v0.1.35          | Planned    | [unplanned.md#F069](features/unplanned.md#f069--electron-主进程统一日志logger工程)                                                                                        |
...
| 075     | Knowledge graph view（entities/concepts/source links 可视化，作为 KB 维护与探索视图）                                                                                            | New          | Low      | v0.2.4           | Planned    | [v0.1.17.md#15-后续阶段](features/v0.1.17.md#15-后续阶段)                                                                                                                 |
| 076     | UI Language Switch and i18n Foundation（中/英显示语言：系统跟随 + 显式覆盖；全局菜单、设置、侧栏、面板、弹窗、toast 走 typed locale）                                            | Enhancement  | High     | v0.1.35          | Planned    | [v0.1.18.md#feature_076-ui-language-switch-and-i18n-foundation](features/v0.1.18.md#feature_076-ui-language-switch-and-i18n-foundation)                                   |
| 077     | dev-only pseudo-locale / 文案扩展 QA（拉长字符串、发现溢出、辅助 i18n 回归）                                                                                                     | Internal     | Low      | v0.1.35          | Planned    | [v0.1.18.md#后续-feature](features/v0.1.18.md#后续-feature)                                                                                                               |
| 078     | i18n scanner 从 advisory 升级为 CI required（阻止新增高频 UI 硬编码文案）                                                                                                        | Internal     | Medium   | v0.1.35          | Planned    | [v0.1.18.md#后续-feature](features/v0.1.18.md#后续-feature)                                                                                                               |
| 079     | 繁体中文 UI 支持（zh-Hant 字典、fallback、排版 QA）                                                                                                                              | Enhancement  | Low      | v0.2.4           | Planned    | [v0.1.18.md#后续-feature](features/v0.1.18.md#后续-feature)                                                                                                               |
...
| 085     | Workflow Durable Replay Resume UI（resumable/replaying/orphaned 状态、恢复/丢弃动作、replay 解释）                                                                               | Enhancement  | High     | v0.1.30          | Planned    | [v0.1.20.md#feature_085-workflow-durable-replay-resume-ui](features/v0.1.20.md#feature_085-workflow-durable-replay-resume-ui)                                             |
| 086     | Workflow Draft Review and Approval UI（generate-without-run / review-before-start 桌面审阅）                                                                                     | New          | High     | v0.1.30          | Planned    | [v0.1.20.md#feature_086-workflow-draft-review-and-approval-ui](features/v0.1.20.md#feature_086-workflow-draft-review-and-approval-ui)                                     |
| 087     | Workflow Pipeline Timeline and Replay-Aware Rendering（pipeline 阶段时间线、fan-out/fan-in、replay 标记）                                                                        | Enhancement  | Medium   | v0.1.30          | Planned    | [v0.1.20.md#feature_087-workflow-pipeline-timeline-and-replay-aware-rendering](features/v0.1.20.md#feature_087-workflow-pipeline-timeline-and-replay-aware-rendering)     |
| 088     | Memory Governance Surface（proposed/approved/conflict/stale memory，区分 Coder memory 与 Partner KB）                                                                            | New          | High     | v0.1.31          | Planned    | [v0.1.20.md#feature_088-memory-governance-surface](features/v0.1.20.md#feature_088-memory-governance-surface)                                                             |
| 089     | Todo Timeline and Session Report（todo_update → durable plan/timeline/session-end report）                                                                                       | Enhancement  | Medium   | v0.1.31          | Planned    | [v0.1.20.md#feature_089-todo-timeline-and-session-report](features/v0.1.20.md#feature_089-todo-timeline-and-session-report)                                               |
| 090     | MCP / Extension Resume State Inspector（resumed session 的 MCP/extension state、missing/stale/reconnect UX）                                                                     | Enhancement  | Medium   | v0.1.31          | Planned    | [v0.1.20.md#feature_090-mcp--extension-resume-state-inspector](features/v0.1.20.md#feature_090-mcp--extension-resume-state-inspector)                                     |
| 091     | Effort-First Provider Routing UI（任务感知 effort/model 控制、能力徽标、why-this-route）                                                                                         | Enhancement  | High     | v0.1.34          | Planned    | [v0.1.20.md#feature_091-effort-first-provider-routing-ui](features/v0.1.20.md#feature_091-effort-first-provider-routing-ui)                                               |
| 092     | Advisor Consult Review Surface（计划/diff/workflow/artifact 的跨模型可验证审阅）                                                                                                 | New          | High     | v0.1.34          | Planned    | [v0.1.20.md#feature_092-advisor-consult-review-surface](features/v0.1.20.md#feature_092-advisor-consult-review-surface)                                                   |
| 093     | Skill Self-Improvement Review Surface（skill proposal/diff/test/activate/rollback）                                                                                              | New          | High     | v0.1.34          | Planned    | [v0.1.20.md#feature_093-skill-self-improvement-review-surface](features/v0.1.20.md#feature_093-skill-self-improvement-review-surface)                                     |
| 094     | Beta Quality, Release Cohesion, and Sandbox Feasibility（版本/docs/diagnostics/provider guard/smoke checklist + 执行沙箱 feasibility）                                           | Internal     | Medium   | v0.1.35          | Planned    | [v0.1.20.md#feature_094-beta-quality-and-release-cohesion](features/v0.1.20.md#feature_094-beta-quality-and-release-cohesion)                                             |
...
| 098     | Policy, Audit, and Local Admin Pack（policy JSON、provider/MCP allowlist、audit export、redaction；不含 SSO/SAML/SCIM）                                                          | New          | High     | v0.2.4           | Planned    | [v0.2.0.md#feature_098-policy-audit-and-admin-pack](features/v0.2.0.md#feature_098-policy-audit-and-admin-pack)                                                           |
| 099     | Self-hosted Runner, Worktree Sandbox, and Long Task Monitor（SSH/Docker profile、copy/worktree sandbox、remote run monitoring）                                                  | New          | Medium   | v0.2.5           | Planned    | [v0.2.0.md#feature_099-remote-runner-and-long-task-monitor](features/v0.2.0.md#feature_099-remote-runner-and-long-task-monitor)                                           |
| 100     | Notebook and Data Work Surface（ipynb preview、cell diff、chart/table artifact，无静默 kernel 执行）                                                                             | New          | Low      | v0.2.5           | Planned    | [v0.2.0.md#feature_100-notebook-and-data-work-surface](features/v0.2.0.md#feature_100-notebook-and-data-work-surface)                                                     |
| 101     | Distribution and Platform Expansion（dev/beta/stable channels、installer hardening、Linux readiness）                                                                            | Internal     | Medium   | v0.2.5           | Planned    | [v0.2.0.md#feature_101-distribution-and-platform-expansion](features/v0.2.0.md#feature_101-distribution-and-platform-expansion)                                           |
| 102     | Surface Extension Points and Slot Registry（typed local slots，内部 surfaces 先用，非 marketplace）                                                                              | Internal     | Medium   | v0.2.5           | Planned    | [v0.2.0.md#feature_102-surface-extension-points-and-slot-registry](features/v0.2.0.md#feature_102-surface-extension-points-and-slot-registry)                             |
| 103     | Pinned Runtime Summary and Live Detail Host（右侧置顶摘要：idle 环境信息 / running live 摘要 / 展开完整信息面板）                                                                | Enhancement  | High     | v0.1.27          | Planned    | [v0.1.27.md#feature_103-pinned-runtime-summary-and-live-detail-host](features/v0.1.27.md#feature_103-pinned-runtime-summary-and-live-detail-host)                         |
...
| 105     | KodaX-AI Fair Core License and Offline Enterprise Entitlement（Community 免费零打扰、Enterprise 离线 license/30 天评估、Professional 预留、客户包独立 terms）                    | New          | High     | v0.1.24          | InProgress | [v0.1.24.md#feature_105-kodax-ai-fair-core-license-and-offline-enterprise-entitlement](features/v0.1.24.md#feature_105-kodax-ai-fair-core-license-and-offline-enterprise-entitlement) |
...
| **v0.1.18** | Emergency released baseline                    | none                                     | Emergency release already shipped; unimplemented i18n foundation moves to v0.1.35.                                                                                                                                               |
...
| **v0.1.27** | Pinned runtime summary                         | F103                                     | Right-side pinned summary shows idle environment or live runtime status, with a clear path into the full information panel.                                                                                                      |
| **v0.1.28-v0.1.29** | Patch reserve                         | none                                     | Reserved for F103 polish, regressions, and urgent SDK follow-up before the next feature pair.                                                                                                                                    |
| **v0.1.30** | Workflow v2 desktop host                       | F085, F086, F087                         | Space supports workflow replay resume, draft review, and pipeline timeline.                                                                                                                                                      |
| **v0.1.31** | Governance surfaces                            | F088, F089, F090                         | Memory, todos, and MCP/extension resume state are visible and reviewable.                                                                                                                                                        |
| **v0.1.32-v0.1.33** | Patch reserve                         | none                                     | Reserved after the workflow/governance feature pair.                                                                                                                                                                            |
| **v0.1.34** | Intelligent control surfaces                   | F091, F092, F093                         | Provider effort, advisor consult, and skill self-improvement are desktop workflows.                                                                                                                                              |
| **v0.1.35** | Beta hardening + sandbox feasibility           | F069, F076, F077, F078, F094             | Logging, full i18n foundation/QA after the F104 MVP, release health, provider guard verification, diagnostics, and sandbox feasibility are coherent for beta users.                                                              |
| **v0.1.36-v0.1.37** | Patch reserve                         | none                                     | Reserved after the control/beta-hardening feature pair.                                                                                                                                                                         |
...
| **v0.2.2-v0.2.3** | Patch reserve                          | none                                     | Reserved after the first two v0.2.x feature-bearing releases.                                                                                                                                                                    |
| **v0.2.4**  | Trust, local admin, knowledge graph            | F053, F075, F079, F098                   | Partner harness trust, local-first policy/audit controls, knowledge graph, and richer localization follow-ups are planned without implying SSO/SAML/SCIM.                                                                        |
| **v0.2.5**  | Platform, runner, sandbox, data surfaces       | F042, F055, F067, F099, F100, F101, F102 | Native helper parking lot, app protocol hardening, LiveCanvas re-integration gate, self-hosted runner/worktree sandbox, notebook/data work, distribution, and slot registry are specified; F105 full legal/distribution follow-ups can feed into F101 as needed. |
| **v0.2.6-v0.2.7** | Patch reserve                          | none                                     | Reserved after the local-admin/platform feature pair.                                                                                                                                                                           |
