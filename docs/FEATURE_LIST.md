...
> **2026-06-18 full feature audit / emergency release cleanup**：校验全部 feature 后，发现 F049/F050/F051/F052/F053/F055/F070/F076 仍无实现证据却挂在已发布版本；F067/F069 仍为 TBD。统一重排：F015/F017/F018 的未完成部分由 v0.1.20 的 F082/F084/F083 承接；F076/F069 进入 v0.1.34 beta hardening；F049/F070/F071/F072/F074/F095 进入 v0.2.0；F050/F051/F052/F073/F080/F096/F097 进入 v0.2.1；F053/F075/F079/F098 进入 v0.2.4；F042/F055/F067/F099-F102 进入 v0.2.5。历史 v0.1.17/v0.1.18 改为 emergency released baseline，不再承载 Planned feature。
> **2026-06-19 GLM gap review follow-up**：吸收合理项但不照单全收。MCP gap 结论作废（F039 已完成）；`CHANGELOG:51` provider 安全风险在当前工作树已有 `apiKeyEnv`/`baseUrl` guard 与测试，作为 F094 release verification；OS 级执行沙箱是战略方向但不打断 v0.1.29-v0.1.33，先在 F094 输出 feasibility，后续与 F099/self-hosted runner 或独立 sandbox feature 合流；PR/GitHub 闭环并入 F096 connector + F095 Partner workbench；企业 SSO/SAML/SCIM 降级为路线选择后再开，F098 只做 local-first policy/audit。
> **2026-06-21 v0.1.26 lane reset**：v0.1.26 改为承载 F103「Pinned Runtime Summary and Live Detail Host」。原 v0.1.26-v0.1.29 的 planned 0.1.x feature 不改 ID、不改状态，按“两版 feature + 两版 patch 预留”的节奏排到 v0.1.29/v0.1.30/v0.1.33/v0.1.34；v0.1.27-v0.1.28、v0.1.31-v0.1.32、v0.1.35-v0.1.36 暂不承载已承诺 feature。
> **2026-06-22 Display Language MVP split**：用户确认中/英显示语言需要提前进入 `v0.1.20`。新增 F104「Display Language MVP」作为 F076 的前置交付：只做可用语言偏好、菜单栏快捷切换、Settings 入口和高频 chrome/弹窗覆盖；F076 仍留在 `v0.1.34` 做全量 i18n foundation、typed locale 扩面、pseudo-locale/CI scanner 前置条件。
> **2026-06-22 patch-lane reservation**: `v0.1.21` shipped as the first patch release; `v0.1.22` is consumed by the provider/queue patch; `v0.1.23` is consumed by F106 runtime defaults; `v0.1.24` remains customer timebox entitlement MVP; `v0.1.25` is now consumed by F107 SDK catch-up and F108 composer input work before F103 starts at `v0.1.26`.
...
> **2026-06-24 v0.1.25+ patch cadence replan**: starting at `v0.1.25`, two feature-bearing versions are followed by two reserved patch version numbers. `v0.1.27-v0.1.28`, `v0.1.31-v0.1.32`, and `v0.1.35-v0.1.36` are patch reserves; later v0.2.x work keeps `v0.2.0-v0.2.1` as the first feature pair, reserves `v0.2.2-v0.2.3`, and moves the later two planned feature lanes to `v0.2.4-v0.2.5`.
...
| 069     | Electron 主进程统一日志（Logger）工程（分级 + 结构化 + 落盘轮转 + 敏感信息脱敏 + 替换 33 文件 console.\* + no-console lint；合流 OC-04/05/10）                                   | Internal     | Low      | v0.1.34          | Planned    | [unplanned.md#F069](features/unplanned.md#f069--electron-主进程统一日志logger工程)                                                                                        |
...
| 076     | UI Language Switch and i18n Foundation（中/英显示语言：系统跟随 + 显式覆盖；全局菜单、设置、侧栏、面板、弹窗、toast 走 typed locale）                                            | Enhancement  | High     | v0.1.34          | Planned    | [v0.1.18.md#feature_076-ui-language-switch-and-i18n-foundation](features/v0.1.18.md#feature_076-ui-language-switch-and-i18n-foundation)                                   |
| 077     | dev-only pseudo-locale / 文案扩展 QA（拉长字符串、发现溢出、辅助 i18n 回归）                                                                                                     | Internal     | Low      | v0.1.34          | Planned    | [v0.1.18.md#后续-feature](features/v0.1.18.md#后续-feature)                                                                                                               |
| 078     | i18n scanner 从 advisory 升级为 CI required（阻止新增高频 UI 硬编码文案）                                                                                                        | Internal     | Medium   | v0.1.34          | Planned    | [v0.1.18.md#后续-feature](features/v0.1.18.md#后续-feature)                                                                                                               |
...
| 085     | Workflow Durable Replay Resume UI（resumable/replaying/orphaned 状态、恢复/丢弃动作、replay 解释）                                                                               | Enhancement  | High     | v0.1.29          | Planned    | [v0.1.20.md#feature_085-workflow-durable-replay-resume-ui](features/v0.1.20.md#feature_085-workflow-durable-replay-resume-ui)                                             |
| 086     | Workflow Draft Review and Approval UI（generate-without-run / review-before-start 桌面审阅）                                                                                     | New          | High     | v0.1.29          | Planned    | [v0.1.20.md#feature_086-workflow-draft-review-and-approval-ui](features/v0.1.20.md#feature_086-workflow-draft-review-and-approval-ui)                                     |
| 087     | Workflow Pipeline Timeline and Replay-Aware Rendering（pipeline 阶段时间线、fan-out/fan-in、replay 标记）                                                                        | Enhancement  | Medium   | v0.1.29          | Planned    | [v0.1.20.md#feature_087-workflow-pipeline-timeline-and-replay-aware-rendering](features/v0.1.20.md#feature_087-workflow-pipeline-timeline-and-replay-aware-rendering)     |
| 088     | Memory Governance Surface（proposed/approved/conflict/stale memory，区分 Coder memory 与 Partner KB）                                                                            | New          | High     | v0.1.30          | Planned    | [v0.1.20.md#feature_088-memory-governance-surface](features/v0.1.20.md#feature_088-memory-governance-surface)                                                             |
| 089     | Todo Timeline and Session Report（todo_update → durable plan/timeline/session-end report）                                                                                       | Enhancement  | Medium   | v0.1.30          | Planned    | [v0.1.20.md#feature_089-todo-timeline-and-session-report](features/v0.1.20.md#feature_089-todo-timeline-and-session-report)                                               |
| 090     | MCP / Extension Resume State Inspector（resumed session 的 MCP/extension state、missing/stale/reconnect UX）                                                                     | Enhancement  | Medium   | v0.1.30          | Planned    | [v0.1.20.md#feature_090-mcp--extension-resume-state-inspector](features/v0.1.20.md#feature_090-mcp--extension-resume-state-inspector)                                     |
| 091     | Effort-First Provider Routing UI（任务感知 effort/model 控制、能力徽标、why-this-route）                                                                                         | Enhancement  | High     | v0.1.33          | Planned    | [v0.1.20.md#feature_091-effort-first-provider-routing-ui](features/v0.1.20.md#feature_091-effort-first-provider-routing-ui)                                               |
| 092     | Advisor Consult Review Surface（计划/diff/workflow/artifact 的跨模型可验证审阅）                                                                                                 | New          | High     | v0.1.33          | Planned    | [v0.1.20.md#feature_092-advisor-consult-review-surface](features/v0.1.20.md#feature_092-advisor-consult-review-surface)                                                   |
| 093     | Skill Self-Improvement Review Surface（skill proposal/diff/test/activate/rollback）                                                                                              | New          | High     | v0.1.33          | Planned    | [v0.1.20.md#feature_093-skill-self-improvement-review-surface](features/v0.1.20.md#feature_093-skill-self-improvement-review-surface)                                     |
| 094     | Beta Quality, Release Cohesion, and Sandbox Feasibility（版本/docs/diagnostics/provider guard/smoke checklist + 执行沙箱 feasibility）                                           | Internal     | Medium   | v0.1.34          | Planned    | [v0.1.20.md#feature_094-beta-quality-and-release-cohesion](features/v0.1.20.md#feature_094-beta-quality-and-release-cohesion)                                             |
...
| **v0.1.18** | Emergency released baseline                    | none                                     | Emergency release already shipped; unimplemented i18n foundation moves to v0.1.34.                                                                                                                                               |
...
| **v0.1.27-v0.1.28** | Patch reserve                         | none                                     | Reserved for F103 polish, regressions, and urgent SDK follow-up before the next feature pair.                                                                                                                                    |
| **v0.1.29** | Workflow v2 desktop host                       | F085, F086, F087                         | Space supports workflow replay resume, draft review, and pipeline timeline.                                                                                                                                                      |
| **v0.1.30** | Governance surfaces                            | F088, F089, F090                         | Memory, todos, and MCP/extension resume state are visible and reviewable.                                                                                                                                                        |
| **v0.1.31-v0.1.32** | Patch reserve                         | none                                     | Reserved after the workflow/governance feature pair.                                                                                                                                                                            |
| **v0.1.33** | Intelligent control surfaces                   | F091, F092, F093                         | Provider effort, advisor consult, and skill self-improvement are desktop workflows.                                                                                                                                              |
| **v0.1.34** | Beta hardening + sandbox feasibility           | F069, F076, F077, F078, F094             | Logging, full i18n foundation/QA after the F104 MVP, release health, provider guard verification, diagnostics, and sandbox feasibility are coherent for beta users.                                                              |
| **v0.1.35-v0.1.36** | Patch reserve                         | none                                     | Reserved after the control/beta-hardening feature pair.                                                                                                                                                                         |
