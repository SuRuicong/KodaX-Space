...
> Last Updated: 2026-06-24 (v0.1.25+ roadmap rebalanced: every two feature-bearing versions now leave two reserved patch version numbers; F085-F094 move to v0.1.29/v0.1.30/v0.1.33/v0.1.34, and later v0.2.x work leaves v0.2.2-v0.2.3 reserved).
